...
function twentysixteen_scripts() {
	...
	wp_enqueue_style( 'bootstrap-css', get_template_directory_uri() . '/css/bootstrap.css', array( 'twentysixteen-style' ));	
	wp_enqueue_style( 'slick-css', get_template_directory_uri() . '/css/slick.css', array( 'twentysixteen-style' ));	
	wp_enqueue_style( 'slick-theme-css', get_template_directory_uri() . '/css/slick-theme.css', array( 'twentysixteen-style' ));
	wp_enqueue_style( 'navigation-css', get_template_directory_uri() . '/css/navigation.css', array( 'twentysixteen-style' ));
	wp_enqueue_style( 'custom-css', get_template_directory_uri() . '/css/custom.css', array( 'twentysixteen-style' ));	
...
add_filter( 'rwmb_meta_boxes', 'twentysixteen_meta_boxes' );
function twentysixteen_meta_boxes( $meta_boxes ) {
    $meta_boxes[] = array(
        'title'      => __( 'Meta Box', 'textdomain' ),
        'post_types' => array( 'post', 'page', 'news', 'work', 'talent' ),
        'fields'     => array(
            array(
                'id'   => 'subtitle',
...
function get_excerpt1($limit){
$excerpt = get_the_content();
$excerpt = utf8_truncate( $excerpt, $limit );
return $excerpt;
}
...
function posttype_init() {
	...
	register_taxonomy('news_category', 'news', array('hierarchical' => true, 'label' => 'Category', 'query_var' => true, 'rewrite' => true));	
	...
	register_taxonomy('talent_category', 'talent', array('hierarchical' => true, 'label' => 'Category', 'query_var' => true, 'rewrite' => true));	
	...
	register_taxonomy('work_category', 'work', array('hierarchical' => true, 'label' => 'Category', 'query_var' => true, 'rewrite' => true));	
}
