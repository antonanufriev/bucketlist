...
<div class="container">
	...
	<div id="pg" class="row">
		...
		<ul class="workpost">
		<?php $page = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts("showposts=8&post_type=talent&paged=$page"); while ( have_posts() ) : the_post() ?>
